"use client";
import { ConfirmModalProps } from "@/types/Modal/ConfirmModal";
...
const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center" onClick={onCancel}>
      <div className="bg-white rounded-lg p-6 w-full max-w-md shadow-lg text-center" onClick={(e) => e.stopPropagation()}>
        <div className="mb-4 flex flex-col items-center">
          ...
          />
          <span className="text-base font-medium leading-6 text-[#505050] my-5">{title}</span>
          {description && (
